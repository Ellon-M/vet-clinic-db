...
A relational SQL database to store vet clinic data, about animals, animal owners, clinic employees and visits.
...
In order to run this project you need an SQL Server installed locally:
